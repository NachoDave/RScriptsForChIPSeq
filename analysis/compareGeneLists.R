...
at1= read.table('/home/rstudio/data/WT1/results/genes/1_PCOS_AR_i7_geneTable.xls',header=T,fill=T,sep='\t')
dat2= read.table('/home/rstudio/data/WT1/results/genes/2_Fertile_WT1_geneTable.xls',header=T,fill=T,sep='\t')
