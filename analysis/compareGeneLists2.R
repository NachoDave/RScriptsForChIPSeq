# Analyse ChIP Seq data for differential analysis ===========================================#
# Author Dave James
# Dave James 05/06/19
#============================================================================================#
...
dat1= read.table('/home/rstudio/data2/WT1_300519/results/genes/1_PCOS_AR_i7_filteredhg38_trim_bowtie2UPBlkLstRm_MACS_geneTable.xls',header=T,fill=T,sep='\t')
dat2= read.table('/home/rstudio/data2/WT1_ActiveMotif/AM Swansea AR WT1 ChIP-Seq analysis with Input 16428/2093Swansea_AR-WT1_genes.xlsx',header=T,fill=T,sep='\t')
...
pdf("/home/rstudio/scripts/analysis/compareWT1_DaveActMot.pdf",height=6,width=6)
grid.newpage()
draw.pairwise.venn(area1 = length(inG1Only), area2 = length(inG2Only), cross.area = length(intsectGn1Gn2), category = 
